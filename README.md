...
More detailed instructions for installation, setup, and usage guides will be available soon.
...
1. Save your screenshots in a folder within your repo, e.g., `assets/` or `screenshots/`.
2. Use the following Markdown syntax to display them:

```md
![Home Screen](screenshots/home.png)
![Tasker Dashboard](screenshots/dashboard.png)
